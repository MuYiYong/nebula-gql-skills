...
Feature: SetStatement on MemGraph

  Scenario: SetPropertyItem
    When executing query:
      """
      CREATE GRAPH TYPE IF NOT EXISTS mem_test_type AS {
    ...
    When executing query:
      """
      CREATE TEMPORARY GRAPH IF NOT EXISTS #mem_test_set TYPED mem_test_type
      """
    Then the execution should be successful
    When executing query:
      """
    ...
    And drop the graph "#mem_test_set"
    And drop the graph type "mem_test_type"

  Scenario: MultipleVariablesIntersections
    When executing query:
      """
      CREATE GRAPH TYPE IF NOT EXISTS mem_test_multi_variable_type AS {
    ...
    When executing query:
      """
      CREATE TEMPORARY GRAPH IF NOT EXISTS #mem_test_set_1 TYPED mem_test_multi_variable_type
      """
    Then the execution should be successful
    When executing query:
      """
    ...
    Then the result should be, in any order:
      | r                           |
      | [{followness:5,likeness:5}] |
    And drop the graph "#mem_test_set_1"
    And drop the graph type "mem_test_multi_variable_type"

  Scenario: SetMultiTypes
    When executing query:
      """
      CREATE GRAPH TYPE IF NOT EXISTS set_multi_types_mem AS {
    ...
    When executing query:
      """
      CREATE TEMPORARY GRAPH IF NOT EXISTS #mem_set_graph TYPED set_multi_types_mem
      """
    Then the execution should be successful
    When executing query:
      """
    ...
    And drop the graph "#mem_set_graph"
    And drop the graph type "set_multi_types_mem"

  Scenario: SetNullValue
    When executing query:
      """
      CREATE GRAPH TYPE IF NOT EXISTS mem_set_null_types AS {
    ...
    When executing query:
      """
      CREATE TEMPORARY GRAPH IF NOT EXISTS #mem_set_null TYPED mem_set_null_types
      """
    Then the execution should be successful
    When executing query:
      """
    ...
    And drop the graph "#mem_set_null"
    And drop the graph type "mem_set_null_types"

  Scenario: SetMultiEdgeKey
    When executing query:
      """
      CREATE GRAPH TYPE IF NOT EXISTS mem_set_multiedge_type AS {
    ...
    When executing query:
      """
      CREATE TEMPORARY GRAPH IF NOT EXISTS #mem_set_multiedge TYPED mem_set_multiedge_type
      """
    Then the execution should be successful
    When executing query:
      """
      USE #mem_set_multiedge
    ...
    Then an Error should be raised:
      ...
      """
    And drop the graph "#mem_set_multiedge"
    And drop the graph type "mem_set_multiedge_type"

  Scenario: SetImplicitCast
    When executing query:
      """
      CREATE GRAPH TYPE IF NOT EXISTS mem_set_cast_type AS {
    ...
    When executing query:
      """
      CREATE TEMPORARY GRAPH IF NOT EXISTS #mem_set_cast TYPED mem_set_cast_type
      """
    Then the execution should be successful
    When executing query:
      """
    ...
    And drop the graph "#mem_set_cast"
    And drop the graph type "mem_set_cast_type"

  Scenario: SetUndirectedEdge
    When executing query:
      """
      CREATE GRAPH TYPE IF NOT EXISTS mem_set_undirected_edge_type AS {
    ...
    When executing query:
      """
      CREATE TEMPORARY GRAPH IF NOT EXISTS #mem_set_undirected_edge TYPED mem_set_undirected_edge_type
      """
    Then the execution should be successful
    And graph "#mem_set_undirected_edge" should be ready to use
    When executing query:
      """
      USE #mem_set_undirected_edge
    ...
    Then the result should be, in any order:
      ...
      | 2    | 12     | 3.0      | 25         | 3    |
      | 3    | 12     | 3.0      | 25         | 2    |
    And drop the graph "#mem_set_undirected_edge"
    And drop the graph type "mem_set_undirected_edge_type"

  Scenario: SetUndirectedEdgeComplex
    When executing query:
      """
      CREATE GRAPH TYPE IF NOT EXISTS mem_set_undirected_complex_type AS {
    ...
    When executing query:
      """
      CREATE TEMPORARY GRAPH IF NOT EXISTS #mem_set_undirected_complex TYPED mem_set_undirected_complex_type
      """
    Then the execution should be successful
    And graph "#mem_set_undirected_complex" should be ready to use
    When executing query:
      """
      USE #mem_set_undirected_complex
    ...
    Then the result should be, in any order:
      | f.since           |
      | DATE "2022-01-01" |
    And drop the graph "#mem_set_undirected_complex"
    And drop the graph type "mem_set_undirected_complex_type"
