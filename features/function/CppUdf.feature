...
Feature: User-defined function
  ...
  Scenario: UDF test
    ...
    When executing query:
      """
      CREATE FUNCTION IF NOT EXISTS _abs(int32) RETURNS int32 EXTERNAL PLUGIN mathUdf
      """
    Then the execution should be successful
    When executing query:
      """
    ...
    Then the result should be, in any order:
      | name   | signature              | function_type       |
      | "_abs" | "_abs(INT32) -> INT32" | "[CPP UDF:mathUdf]" |
      | "_abs" | "_abs() -> INT64"      | "[CPP UDF:mathUdf]" |
    When executing query:
      """
      SHOW USER DEFINED FUNCTION _abs
      """
    ...
    When executing query:
      """
      CREATE FUNCTION _sum(int32...) RETURNS int32 EXTERNAL PLUGIN mathUdf
      """
    Then the execution should be successful
    When executing query:
      """
    ...
    When executing query:
      """
      CREATE FUNCTION _sum(decimal...) RETURNS double EXTERNAL PLUGIN mathUdf
      """
    Then the execution should be successful
    When executing query:
      """
    ...
    Then the result should be, in any order:
      | name   | signature                    | function_type       |
      | "_sum" | "_sum(DECIMAL...) -> DOUBLE" | "[CPP UDF:mathUdf]" |
      | "_sum" | "_sum(INT32...) -> INT32"    | "[CPP UDF:mathUdf]" |
    When executing query:
      """
