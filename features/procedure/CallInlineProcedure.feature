...
Feature: call inline procedure
  ...
  Scenario: CALL with PER NODE on temporary graph
    ...
    When executing query:
      ...
      INSERT (@movie {id:1, title: "Movie 1"}), (@movie {id:2, title: "Movie 2"}), (@movie {id:3, title: "Movie 3"}), (@movie {id:4, title: "Movie 4"})
      """
    Then the execution should be successful
    When executing query:
      """
      CREATE TEMPORARY GRAPH #movie_temporary_graph AS COPY OF g_movie_temp_graph
      """
    Then the execution should be successful
    When executing query:
      """
